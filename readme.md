...
This repository contains my News Summarizer system built using **T5-Base**.  
...
Hugging Face Model: https://huggingface.co/diwasluitel/NewsSummarizer
...
The front-end design was created with assistance from code generation tools to speed up developmentallowing the core project focus to remain exclusively on the back-end NLP model and evaluation process.
